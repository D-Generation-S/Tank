...
namespace TankEngine.EntityComponentSystem.Manager
{
    ...
    /// </summary>
    public interface IComponentManager : IClearable
    {
        /// <summary>
        ...
        /// <returns></returns>
        List<uint> GetEntitiesWithComponent(Type type);
        ...
        /// <returns>A list with all the components</returns>
        List<IComponent> GetComponents(Type componentType);
